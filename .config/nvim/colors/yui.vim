...
hi CursorLine   guibg=#232a3d ctermbg=7 cterm=NONE
hi CursorLineNR guifg=#5c8d9d ctermfg=6
hi LineNr       guifg=#394463 ctermfg=7
hi VertSplit    guifg=#171C29 ctermbg=15 ctermfg=15 cterm=NONE
hi MatchParen   guibg=#7ba4b1 guifg=#1d2333 ctermbg=14 ctermfg=0
hi StatusLine   guibg=#394463 guifg=#171c29 ctermbg=15 ctermfg=NONE cterm=NONE
hi StatusLineNC guibg=#394463 guifg=#171c29 ctermbg=15 ctermfg=NONE cterm=NONE
